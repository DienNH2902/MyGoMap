      ...
      <div className="flex w-full items-center justify-start p-6 md:w-1/2 md:p-12">
        <div className="relative w-full max-w-lg rounded-3xl bg-white p-8 shadow-xl md:p-10">
          ...
          <div className="flex flex-col gap-4 text-slate-800">
            <span className="inline-block w-fit rounded-xl bg-amber-100 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-800">
              Cảnh báo truy cập
            </span>
            ...
            <p className="text-base leading-relaxed text-slate-600">
              Vui lòng nhập tên và giới tính trước khi bắt đầu lập lộ trình nhé.
            </p>
