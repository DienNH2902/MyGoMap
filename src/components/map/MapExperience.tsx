  ...
  return (
    <div className="fixed inset-x-0 bottom-0 top-[var(--header-h)] h-[calc(100dvh-var(--header-h))] overflow-hidden">
      ...
      {isArrivalStopModalOpen && navigation.stopArrivalInfo && (
        <div className="pointer-events-auto fixed left-1/2 top-52 z-[9999] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 overflow-hidden rounded-3xl border border-emerald-400/30 bg-ink/95 shadow-2xl backdrop-blur-xl animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="p-5">
            {/* Header */}
