  ...
  return (
    <div className="fixed inset-x-0 bottom-0 top-[var(--header-h)] h-[calc(100dvh-var(--header-h))] overflow-hidden">
      ...
      {navigation.isNavigating && navigation.speedKmh !== null && (
        <div
          className="pointer-events-none fixed left-4 top-[230px] z-40 flex h-16 w-16 flex-col items-center justify-center rounded-full border-2 border-accent-gold/40 bg-ink/90 shadow-2xl backdrop-blur-md md:hidden"
