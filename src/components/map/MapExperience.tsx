  ...
  return (
    <div className="absolute inset-0 top-16">
      ...
      {planner.aiTip && !isAiTipDismissed && (
        <div className="pointer-events-auto absolute left-4 top-40 z-3000 max-w-xs rounded-2xl border border-accent-gold/30 bg-ink/85 p-4 text-sm text-cream shadow-xl backdrop-blur-md">
